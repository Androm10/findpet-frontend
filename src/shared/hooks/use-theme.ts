...
import { THEME_TOKEN } from 'shared/constants/tokens';
import { themeActions } from 'shared/store/slices/theme.slice';
...
export const useAppTheme = () => {
  ...
  useEffect(() => {
    ...
    const currentTheme =
      themeNameFromStorage && themeNameFromStorage in Themes ? (themeNameFromStorage as Themes) : Themes.light;
