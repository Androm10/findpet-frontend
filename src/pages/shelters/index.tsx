import { useGetSheltersQuery } from '@shared/store/api/shelter.api';
...
const SheltersPage: FC = () => {
  const { data, isLoading, isFetching } = useGetSheltersQuery(undefined);
  ...
  return (
    <div>
      ...
      <ShelterList shelters={data.result} />
    </div>
  );
};
